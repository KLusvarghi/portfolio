        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-xl text-muted-foreground">
              Conheça {resumeData.personalInfo.name},{" "}
          ...
          <Card className="border-2">
            <CardContent className="p-8 space-y-4">
              ...
              <h2 className="text-3xl font-bold leading-tight">
                Desenvolvedor Full Stack apaixonado por tecnologia e soluções
          ...
          <div className="space-y-6">
            ...
            {previousRoles.length > 0 && (
              <div className="space-y-4">
                ...
                >
                  <span>
                    {showPreviousRoles ? "Ocultar" : "Mostrar"} cargos
                    anteriores
                  </span>
                  <ChevronDown
          ...
          <div className="space-y-6">
            ...
            {previousEducation.length > 0 && (
              <div className="space-y-4">
                ...
                >
                  <span>
                    {showPreviousEducation ? "Ocultar" : "Ver mais"} formações
                  </span>
                  <ChevronDown
                    className={`h-4 w-4 transition-transform duration-300 ${
